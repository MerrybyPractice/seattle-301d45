...
function displayPics(){
  ...
  // The console log that I just deconsted with much gusto threw an error because rando was declared with let inside a function delcaraction, redering it locally scoped to that block.
  console.log(viewed);
